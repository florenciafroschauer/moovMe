...
public class DiscountServiceTest {
    ...
    PurchaseLot purchaseLot = new PurchaseLot(keyGenerator, zone1, assetType, 5);
    KeyGenerator keyGenerator1 = new KeyGenerator();
    Asset asset = new Asset(keyGenerator1, zone1, assetType, terminal, purchaseLot);
    DiscountService discountService = new DiscountService();
    @Test
    public void showDiscounts() {
        client.sumScore(10);
        trip.setAsset(asset);
        discountService.canUse(descuento, trip);
